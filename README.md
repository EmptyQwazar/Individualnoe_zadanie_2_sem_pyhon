Индивидуальная работа №2 По дисциплине «Языки программирования Python» выполнил студент ПГНИУ, ИКНТ, 1 курс, группа ИТ-7,8, Антипин Дмитрий Константинович.

Ниже представленно моё индивидуальное задание (Мой вариант и задания)

Вариант 1:


Задание 1(Задание по спискам):
